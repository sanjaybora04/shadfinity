...
export default function Home() {
  return (
    <div className="p-4 max-w-4xl w-full mx-auto min-w-0">
      ...
      <section id="components" className="py-14 px-8">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Link href='/components/text-to-speech-widgit'>
            <Card className="p-6">
              <h4 className="text-xl font-semibold flex gap-2 items-center"><Speech/>Text To Speech Widgit</h4>
              <p className="text-muted-foreground mt-2">A text to speech widgit to read blogs and articles</p>
            </Card>
          </Link>
